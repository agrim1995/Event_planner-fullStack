          ...
          <Link
           ...
           <i className="fa-solid fa-download"></i> Generate
                        ...
                        <div className="col-12">
                            <div className="card">
                                <div className="card-body pb-0 d-flex justify-content-between">
                                    ...
                                    <div>
                                        <ul>
                                            <li className="d-inline-block mr-3"><Link className="text-dark" to="#">Day</Link></li>
                                            <li className="d-inline-block mr-3"><Link className="text-dark" to="#">Week</Link></li>
                                            <li className="d-inline-block"><Link className="text-dark" to="#">Month</Link></li>
                                        </ul>
                                    </div>
                                </div>
            ...
            <div className="row">
                    <div className="col-lg-3 col-sm-6">
                        <div className="card">
                        <Link to="https://www.facebook.com/" target="_blank"> <div className="social-graph-wrapper widget-facebook">
