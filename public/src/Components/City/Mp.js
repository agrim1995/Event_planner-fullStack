                        ...
                        <div className="card-body" style={{padding: "0.88rem 0.81rem"}}>
                            <div className="active-member">
                                ...
                                <div className="d-flex justify-content-between">
                                        <h4>View States</h4>
                                        <Link to="/viewState"><button className="btn btn-primary">View State</button></Link>
                                    </div>
                                    <table className="table table-xs mb-0">
                                        ...
                                        <tbody className=" d-flex justify-content-center">
                                            ...
                                            <tr >
                                                <td >
                                                    <span className='float-none'>Indore</span>
                                                </td>
                                            </tr>
                                            <tr >
                                                <td>
                                                    <span className='float-left'>Bhopal</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <span className='float-left'>jabalpur</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <span className='float-left'>Satna</span>
                                                </td>
                                            </tr>
                                        </div>
